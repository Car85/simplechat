defmodule SimplechatWeb.RoomLive do
  ...
  def handle_info(%{event: "presence_diff", payload: %{joins: joins, leaves: leaves}}, socket) do
    ...
    leave_messages =
     ...
     user_list = SimplechatWeb.Presence.list(socket.assigns.topic)
     |> Map.keys()

    new_messages = join_messages ++ leave_messages
    {:noreply, assign(socket, messages: socket.assigns.messages ++ new_messages, user_list: user_list)}
  end
